	...
	<div class="sf-reset">
		<div class="block">
			<div class="symfony-block-content">
				...
				<p>
					This script will guide you through the basic configuration of your project. You can also do the same
					by editing the ‘<strong>app/config/parameters.yml</strong>’ file directly. </p>
				...
				<?php if (count($minorProblems)): ?>
					...
					<p>
						...
						Symfony experience, it’s recommended that you fix the following: </p>
					<ol>
